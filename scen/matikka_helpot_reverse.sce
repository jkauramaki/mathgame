...
scenario = "Matikka - helpot tehtävät, napit väärinpäin";
active_buttons=2;
...
string filename = "matikka-helpot.txt"; # where to read in the tasks
string clean_log_suffix = "_clean_matikka_helpot_reverse_log.txt";
string mistake_filename = "..\\logs\\matikka_helpot_mistakes.txt";
