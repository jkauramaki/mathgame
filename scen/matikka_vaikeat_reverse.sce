...
scenario = "Matikka - vaikeat tehtävät, napit väärinpäin";
active_buttons=2;
button_codes=0,0; # was 1,2 => using 0,0 so no clutter
write_codes=true;
pulse_width=10;

begin;

TEMPLATE "matikka_definitions_reverse.sce"; 

begin_pcl;
include "matikka.pcl";

string filename = "matikka-vaikeat.txt"; # where to read in the tasks
string clean_log_suffix = "_clean_matikka_vaikeat_reverse_log.txt";
string mistake_filename = "..\\logs\\matikka_vaikeat_reverse_mistakes.txt";
