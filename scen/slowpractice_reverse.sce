...
scenario = "Matikka - hidas harjoitusosio";
active_buttons=2;
button_codes=0,0;
write_codes=false;
pulse_width=10;
...
string filename = "slowpractice.txt";
string clean_log_suffix = "_clean_slowpractice_log.txt";
string mistake_filename = "..\\logs\\slowpractice_mistakes.txt";
